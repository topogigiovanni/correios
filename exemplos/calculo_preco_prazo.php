    ...
    if ($calculo->processaConsulta()) {
        ...
        foreach ($calculo->getRetorno() as $retorno) {
            ...
            if ($retorno->getErro() === 0) {
                ...
                if (($calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_TODOS) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_SO_PRAZO) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_TODOS_COM_DATABASE) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_SO_PRAZO_COM_DATABASE)) {
                ...
                if (($calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_TODOS) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_SO_PRECO) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_TODOS_COM_DATABASE) or ( $calculo->getTipoCalculo() == Correios::TIPO_CALCULO_PRECO_SO_PRECO_COM_DATABASE)) {
